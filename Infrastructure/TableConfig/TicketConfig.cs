...
namespace Infrastructure.TableConfig
{
    internal class TicketConfig : BaseEntityTypeConfiguration<Ticket>
    {
        public override void Configure(EntityTypeBuilder<Ticket> builder)
        {
            ...
            builder.Property(t => t.StatusId).IsRequired().HasDefaultValue((int)Statuss.Open);            
            builder.Property(t => t.PriorityId).IsRequired().HasDefaultValue((int)Prioritys.Medium);            
            builder.Property(t => t.ScoringId).IsRequired().HasDefaultValue((int)Scoring.none);            
